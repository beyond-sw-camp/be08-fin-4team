...
5. [🛠️ Backend](#-backend)
   - [1. Relation Schema](#1-relation-schema)
   - [2. E-R Diagram](#2-e-r-diagram)
   - [3. Table Specification](#3-table-specification)
   - [4. API Specification](#4-api-specification)
   - [5. Backend Test Case](#5-backend-test-case)
6. [🖥️ Frontend](#-frontend)
   - [1. WireFrame](#1-wireframe)
   - [2. UI/UX Test Case](#2-uiux-test-case)
7. [♾️ Infrastructure](#-infrastructure)
   - [1. CI/CD Plan](#1-cicd-plan)
8. [💾 Project Implementation](#-project-implementation)
   - [1. Integrated Test](#1-integrated-test)
